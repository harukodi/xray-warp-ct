...
def generate_warp_config():
    ...
    xray_warp_config_keys = {
        "secretKey": f"{Warp.warp_private_key()}",
        "address": warp_addresses,
        "publicKey": f"{Warp.warp_public_key()}"
    }
    warp_config_data = update_json_keys(handle_xray_json_files(xray_warp_template), keys_to_update=xray_warp_config_keys)
